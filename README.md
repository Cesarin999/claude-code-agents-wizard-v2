...
### Agents Involved
- **🧠 Claude (You)**: You oversee the big picture, managing tasks with clarity and precision.
- **✍️ Coder Subagent**: This agent focuses on one task at a time, keeping everything organized.
- **👁️ Tester Subagent**: This agent verifies each task to ensure everything works as intended.
- **🆘 Stuck Subagent**: If you encounter any issues, this agent will prompt you for help, ensuring no assumptions are made.

## ⚡ Key Features
- **No Fallbacks**: If any agent encounters a problem, it will alert you. You will have complete visibility over what needs your attention.
- **Visual Testing**: Integrated with Playwright, ensuring thorough testing of implementations before finalization.
...
## 📋 User Manual
Once installed, you will have access to a user manual. This will guide you through the functionalities of the application, helping you to get the most out of the software.

### Basic Operations
1. **Starting the Application**: Launch the application from your installed location.
2. **Setting Up a Project**: Use the interface to set up your new project. You can define tasks and assign them to the respective agents.
